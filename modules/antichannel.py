...
import gabby_main
import gabby_main.gabby_modules.json.antilinkedchannel_sql as sql
from gabby_main import SUPPORT_CHAT, TOKEN, dispatcher
from gabby_main.gabby_modules.helper_funcs.anonymous import AdminPerms, user_admin # type: ignore
from gabby_main.gabby_modules.helper_funcs.chat_status import bot_admin, bot_can_delete
from gabby_main.gabby_modules.helper_funcs.chat_status import user_admin as u_admin
from gabby_main.gabby_modules.helper_funcs.decorators gabby, gabbycmd, gabbymsg
from gabby_main.gabby_modules.sql import acm_sql


@gabbycmd(command="antilinkedchan", group=112)
@bot_can_delete
...
@gabby_mainmsg(Filters.is_automatic_forward, group=111)
...
@gabbycmd(command="antichannelpin", group=114)
@bot_admin
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@gabbymsg(Filters.is_automatic_forward | Filters.status_update.pinned_message, group=113)
def eliminate_linked_channel_msg(update: Update, _: CallbackContext):
    message = update.effective_message
    chat = update.effective_chat
