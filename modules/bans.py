...
from gabby.gabby_modules.helper_funcs.anonymous import AdminPerms, user_admin
...
from gabby.gabby_modules.helper_funcs.chat_status import user_admin as u_admin
from gabby.gabby_modules.helper_funcs.chat_status import user_admin_no_reply, user_can_ban
from gabby.gabby_modules.helper_funcs.extraction import extract_user_and_text
from gabby.gabby_modules.helper_funcs.filters import CustomFilters
from gabby.gabby_modules.helper_funcs.string_handling import extract_time
from gabby.gabby_modules.log_channel import gloggable, loggable


# @gabbycmd(command=["ban", "sban", "dban"], pass_args=True)
@connection_status
@bot_admin
@can_restrict
