...
from gabby_config import BOT_ID
from gabby_config import DRAGONS as DEVS
from gabby_config import OWNER_ID
from gabby_main import telethon as Tite
from .events import Puke
from .events import register as Tamod
...
@Tamod(pattern="^/(fsub|Fsub|forcesubscribe|Forcesub|forcesub|Forcesubscribe) ?(.*)")
