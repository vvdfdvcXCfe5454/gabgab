...
from .. import pbot as Gabby,OWNER_ID
from pyrogram.types import ChatPrivileges,ChatPermissions
from pyrogram.types import *
@gabby.on_message(filters.command("gban") & filters.user(OWNER_ID) & ( filters.group | filters.channel) )
...
@gabby.on_message(filters.command("ungban") & filters.user(OWNER_ID) & ( filters.group | filters.channel) )
async def  unbanuser(b,message):
    ...
    try:
        ...
        await message.reply_text(f"failed due to {e}")
@gabby.on_message(filters.command("gbanlist") & filters.user(OWNER_ID))
