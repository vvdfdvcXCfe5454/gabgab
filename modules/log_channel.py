...
from gabby_main.modules11.helper_funcs.decorators igabby_maint gabby_magabby_mainllback, gabby_maincmd
from gabby_main.modules11.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from gabby_main import EVENT_LOGS, LOGGER, dispatcher
    from gabby_main.modules11.helper_funcs.chat_status import is_user_admin
    from gabby_main.modules11.helper_funcs.chat_status import user_admin as u_admin
    from gabby_main.modules11.sql import log_channel_sql as sql
    ...
    @gabby_maincmd(command="logchannel")
    @u_admin
    ...
    @gabby_maincmd(command="unsetlog")
    @user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@gabby_maincallback(pattern=r"log_tog_.*")
