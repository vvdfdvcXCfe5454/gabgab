...
from gabby_main import TIGERS, WOLVES, dispatcher
from gabby_main.modules1111.disable import DisableAbleCommandHandler
from gabby_main.modules1111.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin_no_reply,
)
from gabby_main.modules1111.helper_funcs.extraction import (
    extract_text,
    extract_user,
    extract_user_and_text,
)
from gabby_main.modules1111.helper_funcs.filters import CustomFilters
from gabby_main.modules1111.helper_funcs.misc import split_message
from gabby_main.modules1111.helper_funcs.string_handling import split_quotes
from gabby_main.modules1111.log_channel import loggable
from gabby_main.modules1111.sql import warns_sql as sql
from gabby_main.modules1111.sql.approve_sql import is_approved
...
def warn(
    ...
    if user.id in TIGERS:
        if warner:
            message.reply_text("ʟɪɡʜᴛ ꜱʜᴏᴏᴛᴇʀꜱ ᴄᴀɴᴛ ʙᴇ ᴡᴀʀɴᴇᴅ.")
        else:
            message.reply_text(
                "ʟɪɡʜᴛ ꜱʜᴏᴏᴛᴇʀꜱ ᴛʀɪɡɡʀᴇᴅ ᴀɴ ᴀᴜᴛᴏ ᴡᴀʀɴ ꜰɪʟᴛᴇʀꜱ!\n ɪ ᴄᴀɴ'ᴛ ᴡᴀʀɴ ᴛʜᴇ ʟɪɡʜᴛ ꜱʜᴏᴏᴛᴇʀꜱ ʙᴜᴛ ᴛʜᴇʏ ꜱʜᴏᴜʟᴅ ᴀᴠᴏɪᴅ ᴀʙᴜꜱɪɴɡ ᴛʜɪꜱ."
            )
        return
    ...
    if user.id in WOLVES:
        if warner:
            ...
            message.reply_text(
                "ᴠɪʟʟᴀɪɴꜱ ᴅɪꜱᴀꜱᴛᴇʀ ᴛʀɪɡɡᴇʀᴇᴅ ᴀɴ ᴀᴜᴛᴏ ᴡᴀʀɴ ꜰɪʟᴛᴇʀꜱ!\nɪ ᴄᴀɴ'ᴛ ᴡᴀʀɴ ᴛʜᴇ ᴠɪʟʟᴀɪɴꜱ ʙᴜᴛ ᴛʜᴇʏ ꜱʜᴏᴜʟᴅ ᴀᴠᴏɪᴅ ᴀʙᴜꜱɪɴɡ ᴛʜɪꜱ."
            )
        return
...
def warns(update: Update, context: CallbackContext):
    ...
    if result and result[0] != 0:
        ...
        if reasons:
            text = (
                f"➻ ᴛʜɪꜱ ᴜꜱᴇʀ ʜᴀꜱ {num_warns}/{limit} ᴡᴀʀɴꜱ, ꜰᴏʀ ᴛʜᴇ ꜰᴏʟʟᴏᴡɪɴɡ ʀᴇᴀꜱᴏɴ:"
            )
...
def set_warn_limit(update: Update, context: CallbackContext) -> str:
    ...
    if args := context.args:
        ...
        if args[0].isdigit():
            ...
            msg.reply_text("ɢɪᴠᴇ ᴍᴇ ᴀ ɴᴜᴍʙᴇʀ ᴀꜱ ᴀɴ ᴀʀɡ!")
    else:
        limit, soft_warn = sql.get_warn_setting(chat.id)
...
# """
from gabby_main.modules1111.language import gs
