...
from gabby_config import DEMONS, DEV_USERS, DRAGONS, LOGGER, OWNER_ID
from gabby_config import SUPPORT_CHAT as AbishnoiMF
from gabby_config import WOLVES, dispatcher, sw
from gabby_main.gabby_modules.helper_funcs.anonymous import AdminPerms, user_admin
from gabby_main.gabby_modules.helper_funcs.chat_status import is_user_ban_protected
from gabby_main.gabby_modules.helper_funcs.chat_status import user_admin as u_admin
from gabby_main.gabby_modules.helper_funcs.decorators import (
    gabby_maincmd,
    gabby_mainmsg,
)
from gabby_main.gabby_modules.helper_funcs.misc import build_keyboard, revert_buttons
from gabby_main.gabby_modules.helper_funcs.msg_types import get_welcome_type
from gabby_main.gabby_modules.helper_funcs.string_handling import (
...
@gabby_mainmsg((Filters.status_update.new_chat_members), group=WELCOME_GROUP)
@loggable
...
@gabby_mainmsg((Filters.status_update.left_chat_member), group=WELCOME_GROUP)
...
@gabby_maincmd(command="setwelcome")
...
@gabby_maincmd(command="resetwelcome")
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
...
@gabby_maincmd(command="setgoodbye")
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
...
@gabby_maincmd(command="resetgoodbye")
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
...
@gabby_maincmd(command="welcomemute")
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
...
@gabby_maincmd(command="cleanwelcome")
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
...
@gabby_maincmd(command="cleanservice")
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@gabby_maincallback(pattern=r"user_join_")
...
@gabby_maincallback(pattern=r"user_captchajoin_\([\d\-]+,\d+\)_\(\d{4}\)")
...
"""
@gabby_maincmd(command="lockgroup", pass_args=True)
...
@gabby_maincmd(command="welcomehelp")
@u_admin
def welcome_help(update: Update, context: CallbackContext):
    update.effective_message.reply_text(WELC_HELP_TXT, parse_mode=ParseMode.MARKDOWN)


@gabby_maincmd(command="welcomemutehelp")
@u_admin
...
@gabby_maincallback(pattern=r"wlc_help_")
